# Preparing for Google SWE Position

## Initial Study Plan: 
First read the CTCI chapters without thinking much about the solutions of problems and try to get as much theory knowledge as you can. Problems in interview maybe similar to some problem you know but high chances are they are new to you, there you'll need the theoretical knowledge to break problem down. 
Then goto exercise and try understanding the question. Understanding question is more important that even solving it. Try to make a brute force attempt. If you are not getting solve it using hints. If not download solutions and read it. If you followed last procedure then write algo after reading on paper.
Use white board to temporary marker to solve problems.
...
Use C++ solutions and later practice in C#.
...
Don’t forget the advanced topics section in CTCI.
You should have a last 2 days revision plan and InFlight/Interview morning topics ready on tips cards. These are the things you think are hard to remember so you would like to see them as last thing before interview.
...
https://www.algoexpert.io  (Premium member - 65 questions)
https://leetcode.com/problemset/algorithms/
https://www.geeksforgeeks.org -> For all codes and questions
...
The interview process looks like below
 
0. Preparation time, study & practice → you are here take max. time to prepare
1. Hangouts Screening Technical Interview (1-2 interview x 45 mins) - Software Engineering
For two different programming languages probably more than 1 interview.
2. Onsite Interviews (4-5 interviews x 45 mins in a Google office)
2x for C++ and 2 x for C# (or your primary working language)
